...
@Component({
  selector: 'app-borewell-map',
  templateUrl: './borewell-map.component.html',
  styleUrls: ['./borewell-map.component.css']
})
export class BorewellMapComponent implements  AfterViewInit{
